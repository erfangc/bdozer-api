...
class StockAnalyzer(
    ...
    fun analyze(): StockAnalysis2 {
        ...
        val originalModel = originalAnalysis.model
        ...
        val readyForEvaluationModel = autoGeneratedModel.copy(
            incomeStatementItems = overlayWithOverrides(autoGeneratedModel.incomeStatementItems, autoGeneratedModel.itemOverrides),
            balanceSheetItems = overlayWithOverrides(autoGeneratedModel.incomeStatementItems, autoGeneratedModel.itemOverrides),
        )
